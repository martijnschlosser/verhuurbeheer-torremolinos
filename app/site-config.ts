export const siteConfig = {
  ...
  location: {
    ...
    language: "nl-NL",
    areas: ["Torremolinos Centro","La Carihuela","Playamar","Los Álamos","Montemar","El Bajondillo","El Pinillo","La Colina","El Calvario","Cortijo de Maza"],
  },
  assets: {
  ...
  seo: {
    ...
    description: "Fullservice verhuurbeheer in Torremolinos voor Nederlandse eigenaren. Airbnb, Booking.com, gastenservice, schoonmaak, onderhoud en woningcontroles.",
    primaryKeywords: [
      "verhuurbeheer Torremolinos",
      "Nederlandse verhuurmakelaar Torremolinos",
      "sleutelbeheer Torremolinos",
    ...
    longTailKeywords: [
      ...
      "Nederlandse verhuurmakelaar voor appartement in Torremolinos",
      ...
      "appartement laten verhuren in Torremolinos met beheer",
      "villa laten verhuren in Torremolinos met Nederlandstalige beheerder",
      "tweede woning beheren op afstand in Torremolinos",
      "sleutelbeheer voor tweede woning in Torremolinos",
      "Airbnb en Booking beheer in Torremolinos",
      "rendement vakantiewoning in Torremolinos",
      "property management in Torremolinos voor Nederlandse eigenaren",
      "wat kost verhuurbeheer in Torremolinos",
    ],
  },
  analytics: {
    ...
    searchConsoleVerification: process.env.NEXT_PUBLIC_GOOGLE_SITE_VERIFICATION ?? "arcC4o1H36iumgfVkmJV_usywr0f1IjD_tYmbkzteW4",
  },
} as const;
